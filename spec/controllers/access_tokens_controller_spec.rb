...
RSpec.describe AccessTokensController, type: :controller do
  describe 'POST #create' do
    ...
    #   let(:user) { FactoryBot.create :user, login: 'invalid', password: 'secret' }
    ...
    #   let(:user) { FactoryBot.create :user, login: 'jsmith', password: 'invalid' }
    #   subject { post :create, params: params }
    ...
    #   let(:user) { FactoryBot.create :user, login: 'jsmith', password: 'secret' }
    #   subject { post :create, params: params }
